...
output = open("../../../output/faster-rcnn/faster-rcnn_voc2007.txt", "w")
...
def detect(net, image_name):
    ...
    # Load the image
    im_file = os.path.join('../../../data/VOC2007/Images', image_name)
...
if __name__ == '__main__':
    ...
    im_names = []
    f = open('../../../data/VOC2007/Txt/test.txt', "r")
    for im_name in f:
    ...
    for im_name in im_names:
        print '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
        print 'Detection for ../../../data/VOC2007/Images/'+im_name
        detect(net, im_name)
